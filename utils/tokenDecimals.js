...
const TOKENS_DECIMALS = {
    ...
    "BoTW6r3c6w2VdvStF2rGPwV99WJH5XLFkdRYg3eP1JfJ": {
        "decimals": 6,
        "symbol": "FSTR"
    },
    ...
    "HezGWsJAGXZ739VHQZ7LBXRyF8unkbRAoBeLm2j6YF2u": {
        "decimals": 6,
        "symbol": "PYUSD"
    },
    "8Y7k6iYQAiV6XQwN4o4kMuUb7g8SaYwMgG5q2FsJ4Ztz": {
        "decimals": 6,
        "symbol": "NOMU"
    },
...
// Combine all token data into a single lookup object
...
function hasTokenDecimals(mint) {
    return mint in TOKENS_DECIMALS;
}
...
function getAllCachedMints() {
    return Object.keys(TOKENS_DECIMALS);
}
...
function getTokensWithSymbols() {
    return Object.entries(TOKENS_DECIMALS)
